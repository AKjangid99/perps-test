import { type EngineResponse } from "../types/engineRequest";
...
export async function waitForEngineResponse(correlationId: string, timeoutMs: number,): Promise<EngineResponse> {
